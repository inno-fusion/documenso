...
export function meta({ params: { slug } }: Route.MetaArgs) {
  ...
  return [
    { title: '0xMetaLabs - Share' },
    { description: 'I just signed a document in style with 0xMetaLabs!' },
    {
      property: 'og:title',
      content: '0xMetaLabs - Digital Document Signing',
    },
    {
      property: 'og:description',
      content: 'I just signed with 0xMetaLabs!',
    },
    {
      property: 'og:type',
      content: 'website',
...
export const loader = async ({ request, params: { slug } }: Route.LoaderArgs) => {
  ...
  // Is hardcoded because this whole meta is hardcoded anyway for 0xMetaLabs.
